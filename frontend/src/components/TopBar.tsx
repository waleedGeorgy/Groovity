...
const TopBar = () => {
    ...
    return (
        <nav className="flex flex-row gap-3 items-center justify-between sticky top-0 backdrop-blur-lg z-10 bg-card py-3 px-4 rounded-t-lg">
            <div className="flex items-center justify-center gap-2">
                <img src={logo} alt="Icon of groovity" className="size-7 md:size-8" />
