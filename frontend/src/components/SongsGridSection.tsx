...
const SongsGridSection = ({ songs, title, icon, loading, error }: songsGridProps) => {
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="grid grid-cols-[repeat(auto-fill,14rem)] gap-3 place-items-center">
        {!loading && error ?
          <h2 className="col-span-full place-items-start text-destructive">Could not fetch songs -{" "}
