...
const HomePage = () => {
    const { featuredSongs, personalizedSongs, trendingSongs, getPersonalizedSongs, getTrendingSongs, getFeaturedSongs, error, isLoading } = useMusicStore();

    const { initializeSongsQueue } = usePlaybackStore();
